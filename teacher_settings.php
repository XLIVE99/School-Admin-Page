                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="teacher_settings.php">Settings</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            {
                                $query = $dbh ->prepare("SELECT TEACHER_PASSWORD from teacher WHERE TEACHER_ID = :tid");
                                ...
                                if(empty($i_oldP))
                                {
                                    echo "<p style=\"color:#dc3545;\">Please enter current password!</p>";
                                    $is_valid = false;
                                }
								...
								if($is_valid)
								{
									$query = $dbh ->prepare("UPDATE teacher SET TEACHER_PASSWORD = :new_p WHERE TEACHER_ID = :tid");
