                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="main_teacher.php">Main Page</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">My Courses and Students</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query = $dbh ->prepare("SELECT student.STUDENT_ID, student.STUDENT_NAME, lesson.LESSON_NAME, lesson.LESSON_DESC, class.NOTE from teacher INNER JOIN lesson on teacher.TEACHER_ID = lesson.TEACHER_ID INNER JOIN class on lesson.LESSON_ID = class.LESSON_ID INNER JOIN student on class.STUDENT_ID = student.STUDENT_ID WHERE teacher.TEACHER_ID = :tid");
