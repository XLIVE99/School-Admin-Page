...
<head>
    ...
    <title>E-SHOKUL - All Courses</title>
    <!-- Bootstrap CSS -->
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="teacher_lessonList_All.php">All Courses</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">All Courses</h2>
                            <!-- <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p> -->
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Generic</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">All Courses</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                        <?php
                                            $query = $dbh ->prepare("SELECT teacher.TEACHER_NAME, lesson.LESSON_NAME, lesson.LESSON_DESC from teacher INNER JOIN lesson on teacher.TEACHER_ID = lesson.TEACHER_ID");
